        ...
        <View style = {styles.container} behavior="padding">
            ...
            {!!initialVal.name 
                ? <Button title = "Update"  onPress = {() => {
                    CatStore.update(s => {
                        s.cats[initialVal.id] = {name: name, breed: breed, description: description, characteristics: characteristics, id: initialVal.id}
                    })
             ...
             : <Button title = "create" onPress={() => {
                    CatStore.update(s => {
                        s.cats.push({name: name, breed: breed, description: description, characteristics: characteristics, id: s.cats.length})
                        navigation.navigate('Home')
